    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-gray-400">
          Enter your financial information to get a smart recommendation.
        </p>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-5">
          <Input
            ...
            hint="Total cost of the product you want to buy"
            required
          />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) => update("emergency_fund", e.target.value)}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input
              ...
              onChange={(e) => update("emi_months", e.target.value)}
              placeholder="e.g., 12"
