/**
 * FinPilot AI - Budget Planner Page (Coming Soon)
 */
  ...
  return (
    <PageWrapper title="Budget Planner" subtitle="Optimize your monthly spending">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        >
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-violet-600 to-purple-600 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-violet-500/30">
