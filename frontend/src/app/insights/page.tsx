/**
 * FinPilot AI - Financial Insights Page (Coming Soon)
 */
  ...
  return (
    <PageWrapper title="Financial Insights" subtitle="Analytics and intelligence for your finances">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        >
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-amber-600 to-orange-600 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-amber-500/30">
            <BarChart3 className="w-10 h-10 text-white" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-2">Coming Soon</h2>
          <p className="text-gray-400 max-w-md mx-auto text-sm">
            Financial Insights will give you deep analytics, trend visualizations, and AI-driven intelligence about your money.
          </p>
        </motion.div>
