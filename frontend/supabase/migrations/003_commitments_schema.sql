...
-- Run this SQL in Supabase Dashboard → SQL Editor (if tables do not already exist)
...
CREATE POLICY "Users can view own commitment payments"
  ON public.commitment_payments FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can insert own commitment payments"
  ON public.commitment_payments FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own commitment payments"
  ON public.commitment_payments FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY "Users can delete own commitment payments"
  ON public.commitment_payments FOR DELETE USING (auth.uid() = user_id);
...
CREATE POLICY "Users can view own commitment AI insights"
  ON public.commitment_ai_insights FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can insert own commitment AI insights"
  ON public.commitment_ai_insights FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own commitment AI insights"
  ON public.commitment_ai_insights FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY "Users can delete own commitment AI insights"
  ON public.commitment_ai_insights FOR DELETE USING (auth.uid() = user_id);
...
CREATE POLICY "Users can view own commitment notifications"
  ON public.commitment_notifications FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can insert own commitment notifications"
  ON public.commitment_notifications FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own commitment notifications"
  ON public.commitment_notifications FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY "Users can delete own commitment notifications"
  ON public.commitment_notifications FOR DELETE USING (auth.uid() = user_id);
